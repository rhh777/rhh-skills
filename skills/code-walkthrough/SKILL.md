...
- [建全景] 建议讲解路线后:"先讲哪一步?"(列出各步骤为选项)。
- [下钻循环] **① 对齐意图**确认:给出诸如「符合预期 / 不符,我另有预期 / 我有疑问,想追问 / 跳到别处」之类的选项。
- **③ 标记存疑**裁决:「确认是问题,记入清单 / 没事,这是有意为之 / 我也不确定,先标记」。
- 把推荐项放第一个并标注「(推荐)」。
只有当用户的回答本质是开放式的(需要他用自己的话解释预期、或自由追问)时,才回到纯文本对话。
